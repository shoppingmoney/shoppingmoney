    ...
    <body style="background:#fff;">
		...
		<section class="page-content" style="padding: 51px 0px;">
			<div class="container">
				...
				<div class="row">
				<div class="col-md-12">
<div class="col-md-10" style="padding:6px;background:#26acce; font-size:20px;text-align:center;float:none;margin: 0px auto;">
				            <div class="">
				...
				<div class="col-md-12">
<div class="col-md-10" style="padding-top:13px;/* padding-left: 0px; *//* padding-right: 0px; */margin: 0px auto;float: none;/* margin-left:3%; */">
				            <div class="toch-review-title">
							<h4 class="hd">1. Heading 1</h4>
      <img src="img/agb.png" class="im">                                           
<ul class="txxt">
<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Lorem Ipsum is simply dummy text </li>
<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Lorem Ipsum is simply dummy text </li>
<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Lorem Ipsum is simply dummy text </li>
											 ...
											 <div class="toch-review-title2">
							<h4 class="hd">2. Heading 2</h4>
							<img src="img/agb.png" class="im">                                           
<ul class="txxt">
...
<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Lorem Ipsum is simply dummy text </li>
											 ...
											 <div class="toch-review-title3">
							<h4 class="hd">3. Heading 3</h4>
  <img src="img/agb.png" class="im">                                           
<ul class="txxt">                                              
<ul>
<li><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Lorem Ipsum is simply dummy text </li>
