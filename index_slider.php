                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-md-4">
                        <div class="pdf-thumb-box"> <a href="<?php echo $gt['link'] ?>">
                            ...
                            <div class="col-lg-12" style="background:#1f1f1f;color:#fff;">
                                <h3 style="color: #fff;padding-top:3px;"><?php echo $gt['banner_name']?></h3>
                                                            ...
                                                            <div class="single-product" style="background:#fff;">
																...
																<!--		 <img class="primary-img" src="<?=$imgs[0];?>" alt="Product">
																	<img class="secondary-img" src="<?=$imgs[1];?>" alt="Product"> -->
																	 ...
																	 <img class="primary-img" src="<?=$imgs[1];?>" alt="Product">
																	<img class="secondary-img" src="<?=$imgs[2];?>" alt="Product"> 
                                                                    </a>
                                                                </div>
                                                                <div class="product-description">
                                                                    <h5 style="margin-left:7%;"><a href="#"><?php echo $nth['title'] ?></a></h5>
...
$dbAccess->insertData("wishlist","user_id,product_id,status","'".$_SESSION['myemail']."','".$_GET['q']."','1'");
  ...
  xhttp.send();
                                                                            ...
                                                                            <a href="#" class="modal-view" data-toggle="modal" data-target="#checkoutresume1"><i class="fa fa-search-plus"></i></a>
                                                                        </div>
                                                                    </div>
                                                                </div>												
                                                            </div>
...
"><h4>Our latest video</h4></a>
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="container">
							<?php
							$getData=$dbAccess->selectData("select * from selfie where status='1' and size='bigimg' order by rand() limit 1");
	...
	<?php
							$getData=$dbAccess->selectData("select * from selfie where status='1' and size='smallimg' order by rand() limit 4");
		...
		<!-- /.CDN -->
		<script type="text/javascript" src="testslider/js/jquery.anoslide.js"></script>
		<style type="text/css">
			...
			<div class="carousel" data-mixed>
				...
				<ul>
					<li style="width:200px;">
						<div class="wrap"><figure><img data-src="http://www.visualarchery.com/wp-content/themes/visualarchery/images/portfolio/2014/10/SBS-Mobile-04.png" src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="" /></figure></div>
					</li>
					<li style="width:200px;">
						<div class="wrap"><figure><img data-src="http://www.visualarchery.com/wp-content/themes/visualarchery/images/portfolio/2014/10/SBS-Mobile-04.png" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" /></figure></div>
					</li>
