...
<div class="line" style="border-left:1px dotted grey; width:2px; height: 426px;margin-left: 41%;"></div>
        ...
        <div class="col-md-5" style="margin-top: 2.5%;">	
            <div id="contain_slide">
                ...
                <div class="col-md-12">
                     <img src="img/ben.png" style="width:461px;">
                </div>
                <!----<div class="col-md-7"> 
                    <h2>Our values</h2>
	...
	<!------------------social media and promotions------->
	 ...
	 <div class="col-md-11" style="margin-left:8%;">
        ...
        <div class="col-md-1" style="height:470px;">
              <div class="prev-year" style="background:#da7777; color:#fff; border-radius:550px; width:44px; height:44px; font-size:15px;    padding: 11px 17px; margin-left: 11%;"  >2</div>
...
<div class="col-md-11" style="margin-left:8%;">
        ...
        <div class="col-md-1" style="height:470px;">
              <div class="prev-year" style="background:#da7777; color:#fff; border-radius:550px; width:44px; height:44px; font-size:15px;    padding: 11px 17px; margin-left: 11%;"  >4</div>
