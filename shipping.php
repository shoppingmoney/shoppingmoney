...
<div class="col-md-12" style="padding:6px;background:#26acce; font-size:20px;text-align:center;float:none;margin: 0px auto;">
				            <div class="">
                                                <h2 style="color:#fff;">Shipping and Delivered policy</h2>
    ...
    text-align: justify;">
				<br>
				 <h4 style="text-align:center;">We usually ship the product within 2 working days after receiving the order.</h4>
