...
<div class="tabordion">
  <section id="section1">
    ...
    <label for="option1" style="margin-top:-4%;" class="btn btn-primary" >Online Banking</label>
    <article>
<div class="col-md-12" style="padding:10px;">
  ...
  <section id="section3">
    ...
    <label for="option3" style="margin-top:-4%;" class="btn btn-primary">My Account</label>
    <article>
    <h4> Redeem from my account</h4>
      <div class="col-md-5" style="margin-top:4%;"><input type="text" class="form-control" name="Point" id="userid" placeholder="Point" required="" style="width:250px;"><br>
      </div>
    </article>
  </section>
...
//echo $tr['qty'];						
							...
							<tr style="border-bottom: 1px solid black; padding-bottom:10px;" ><td>Quantity:<?=$tr['qty'];?></td>
							   <td>Rs.<?=$tr['mrp']+$shipping['shipping_charge'];?></td>
