...
$getdadaname=$dbAccess->selectSingleStmt("select * from product_category where id='".$getPname['parent_id']."'");
?>
							<li><a href="javascript:void(0)"><?=$getdadaname['category_name'];?> &nbsp;/</a></li>
...
<div class="price-box" style="padding: 10px 3px 1px;   text-align: -webkit-center;float:none;">
<p><b><?=$tyu['title'];?></b></p>
</div>
		</div>
            <?php } ?>	
...
<center><a class="tag" href="#">
    ...
    ?>
		...
		<div class="mainpro" style="margin-right: 82px;">
		...
		<div class="productboxtrend" style="margin-right:38px;" >
		  ...
		  <a href="product-details.php?pid=<?=$trr['product_id'];?>" class="striplatest">
                 <p>Lorem Ipsum Donar</p>
