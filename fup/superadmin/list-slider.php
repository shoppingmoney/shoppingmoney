...
if(isset($_GET['status'])){
	@extract($_GET);
	$dbAccess->updateData("UPDATE slider SET status='$status' WHERE id=$id");
	die();
}
//for ajax requestAct
if(isset($_GET['delid'])){
	@extract($_GET);
	$dbAccess->updateData("delete from slider WHERE id=$delid");
	header("location:list-slider.php");
	die();
}
$getData = $dbAccess->selectData("select * from  slider ");
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
        ...
        xmlhttp.open("GET", "list-slider.php?id=" + id + "&status="+st, true);
        xmlhttp.send();
					  }
				  }
...
function deleteme(id){
	...
	if(flag){
		window.location='list-slider.php?delid='+id;
	}
}
				  </script>
