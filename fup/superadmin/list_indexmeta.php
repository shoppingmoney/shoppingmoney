...
if(isset($_GET['status'])){
	@extract($_GET);
	$dbAccess->updateData("UPDATE index_meta SET status='$status' WHERE id=$id");
	die();
}
//for ajax requestAct
if(isset($_GET['delid'])){
	@extract($_GET);
	$dbAccess->updateData("delete from index_meta WHERE id=$delid");
	header("location:list_catbanner.php");
	die();
}
$getData = $dbAccess->selectData("select * from  index_meta ");
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
        ...
        xmlhttp.open("GET", "list_indexmeta.php?id=" + id + "&status="+st, true);
        xmlhttp.send();
					  }
				  }
...
function deleteme(id){
	...
	if(flag){
		window.location='list_indexmeta.php?delid='+id;
	}
}
				  </script>
