                  ...
                  <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Vendor Uploaded</a>
                        </li>
                      </ul>
					  ...
					  ?></td>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
						 <p class="lead">Download Documents</p>
                         <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="x_content">
                  <ul class="to_do">
				  <?php foreach ($getData2 as $t) { ?>
                    <li>
                      <a href="venderDownload.php?document=<?= $t['id']; ?>">
                        <?= $t['docs']; ?> </a>
                    </li>
				  <?php } ?>
                  </ul>
