...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="details_of_capris_shorts_fabric_multi_select" value="<?=$res['details_of_capris_shorts_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Color $Multi-Select
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_capris_shorts_color_multi_select">
			<option value="">Select</option>
			<option <?php if($res['details_of_capris_shorts_color_multi_select'] == 'All') echo "selected";?>>All</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Black') echo "selected";?>>Black</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Blue') echo "selected";?>>Blue</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Bronze') echo "selected";?>>Bronze</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Brown') echo "selected";?>>Brown</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Copper') echo "selected";?>>Copper</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Dark Green') echo "selected";?>>Dark Green</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Gold') echo "selected";?>>Gold</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Green') echo "selected";?>>Green</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Grey') echo "selected";?>>Grey</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Light Green') echo "selected";?>>Light Green</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Light Blue') echo "selected";?>>Light Blue</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Maroon') echo "selected";?>>Maroon</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Orange') echo "selected";?>>Orange</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Pink') echo "selected";?>>Pink</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Purple') echo "selected";?>>Purple</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Red') echo "selected";?>>Red</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Silver') echo "selected";?>>Silver</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'White') echo "selected";?>>White</option>
			<option  <?php if($res['details_of_capris_shorts_color_multi_select'] == 'Yellow') echo "selected";?>>Yellow</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_capris_shorts_length">
			<option value="">Select</option>
			<option <?php if($res['details_of_capris_shorts_length'] == '3/4th') echo "selected";?>>3/4th</option>
			<option  <?php if($res['details_of_capris_shorts_length'] == 'Full') echo "selected";?>>Full</option>
			<option  <?php if($res['details_of_capris_shorts_length'] == 'Mid') echo "selected";?>>Mid</option>
			<option  <?php if($res['details_of_capris_shorts_length'] == 'Normal') echo "selected";?>>Normal</option>
			<option  <?php if($res['details_of_capris_shorts_length'] == 'Short') echo "selected";?>>Short</option>
		</select>
	</div>
</div>
<div class="form-group">
