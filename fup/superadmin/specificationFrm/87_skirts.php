...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="skirt_description_fabric_multi_select" value="<?=$res['skirt_description_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="skirt_description_style">
			<option value="">Select</option>
			<option <?php if($res['skirt_description_style'] == 'Asymmetric') echo "selected";?>>Asymmetric</option>
			<option  <?php if($res['skirt_description_style'] == 'Body Fit') echo "selected";?>>Body Fit</option>
			<option  <?php if($res['skirt_description_style'] == 'Flared') echo "selected";?>>Flared</option>
			<option  <?php if($res['skirt_description_style'] == 'Pencil') echo "selected";?>>Pencil</option>
			<option  <?php if($res['skirt_description_style'] == 'Midi') echo "selected";?>>Midi</option>
			<option  <?php if($res['skirt_description_style'] == 'Mini Skirts') echo "selected";?>>Mini Skirts</option>
			<option  <?php if($res['skirt_description_style'] == 'Pleated') echo "selected";?>>Pleated</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="skirt_description_length">
			<option value="">Select</option>
			<option <?php if($res['skirt_description_length'] == 'Above Knee') echo "selected";?>>Above Knee</option>
			<option  <?php if($res['skirt_description_length'] == 'Knee Length') echo "selected";?>>Knee Length</option>
			<option  <?php if($res['skirt_description_length'] == 'Midi') echo "selected";?>>Midi</option>
			<option  <?php if($res['skirt_description_length'] == 'Mixi') echo "selected";?>>Mixi</option>
			<option  <?php if($res['skirt_description_length'] == 'Mini') echo "selected";?>>Mini</option>
		</select>
	</div>
</div>
<div class="form-group">
