...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="shapewear_style_fabric_fabric">
			<option value="">Select</option>
			<option <?php if($res['shapewear_style_fabric_fabric'] == 'Cotton Lycra') echo "selected";?>>Cotton Lycra</option>
			<option  <?php if($res['shapewear_style_fabric_fabric'] == 'Neoprene') echo "selected";?>>Neoprene</option>
			<option  <?php if($res['shapewear_style_fabric_fabric'] == 'Nylon Polyester') echo "selected";?>>Nylon Polyester</option>
			<option  <?php if($res['shapewear_style_fabric_fabric'] == 'Nylon Spandex') echo "selected";?>>Nylon Spandex</option>
			<option  <?php if($res['shapewear_style_fabric_fabric'] == 'Polyamide Spandex') echo "selected";?>>Polyamide Spandex</option>
			<option  <?php if($res['shapewear_style_fabric_fabric'] == 'Polyester') echo "selected";?>>Polyester</option>
		</select>
	</div>
</div>
<div class="form-group">
