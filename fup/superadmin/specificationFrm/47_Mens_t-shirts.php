...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Neckline
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="neckline_details_neckline">
			...
			<option  <?php if($res['neckline_details_neckline'] == 'Hooded') echo "selected";?>>Hooded</option>
			<option  <?php if($res['neckline_details_neckline'] == 'Mandarin') echo "selected";?>>Mandarin</option>
			<option  <?php if($res['neckline_details_neckline'] == 'Polo Neck') echo "selected";?>>Polo Neck</option>
			<option  <?php if($res['neckline_details_neckline'] == 'Round Neck') echo "selected";?>>Round Neck</option>
			<option  <?php if($res['neckline_details_neckline'] == 'V-Neck') echo "selected";?>>V-Neck</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="mens_specification_sleeve_length">
			...
			<option  <?php if($res['mens_specification_sleeve_length'] == 'Full Sleeve') echo "selected";?>>Full Sleeve</option>
