...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="type_for_fusion_type">
			<option value="">Select</option>
			<option <?php if($res['type_for_fusion_type'] == 'Dhoti Set') echo "selected";?>>Dhoti Set</option>
			<option <?php if($res['type_for_fusion_type'] == 'Ethnic Jackets') echo "selected";?>>Ethnic Jackets</option>
			<option  <?php if($res['type_for_fusion_type'] == 'Ethnic Plazzo') echo "selected";?>>Ethnic Plazzo</option>
			<option  <?php if($res['type_for_fusion_type'] == 'Ethnic Skirt') echo "selected";?>>Ethnic Skirt</option>
			<option  <?php if($res['type_for_fusion_type'] == 'Kurta/Kurti Set') echo "selected";?>>Kurta/Kurti Set</option>
			<option  <?php if($res['type_for_fusion_type'] == 'Lahenga Set') echo "selected";?>>Lahenga Set</option>
		</select>
	</div>
</div>
<div class="form-group">
