...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="panties_and_pattern_type_style">
			<option value="">Select</option>
			<option <?php if($res['panties_and_pattern_type_style'] == 'Basic') echo "selected";?>>Basic</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Bikini') echo "selected";?>>Bikini</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Boyshorts') echo "selected";?>>Boyshorts</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Disposable') echo "selected";?>>Disposable</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'G-Strings') echo "selected";?>>G-Strings</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Maternity') echo "selected";?>>Maternity</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Period') echo "selected";?>>Period</option>
			<option  <?php if($res['panties_and_pattern_type_style'] == 'Seamless') echo "selected";?>>Seamless</option>
		</select>
	</div>
</div>
<div class="form-group">
