...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="kurta_kurti_details_fabric_multi_select" value="<?=$res['kurta_kurti_details_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="kurta_kurti_details_length">
			<option value="">Select</option>
			<option <?php if($res['kurta_kurti_details_length'] == 'Long') echo "selected";?>>Long</option>
			<option  <?php if($res['kurta_kurti_details_length'] == 'Mid') echo "selected";?>>Mid</option>
			<option  <?php if($res['kurta_kurti_details_length'] == 'Short') echo "selected";?>>Short</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Collars & Neck
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="kurta_kurti_details_collars_neck" value="<?=$res['kurta_kurti_details_collars_neck']?>">
	</div>
</div>
<div class="form-group">
