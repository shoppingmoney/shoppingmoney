...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="camisoles_detail_fabric_multi_select">
			<option value="">Select</option>
			<option <?php if($res['camisoles_detail_fabric_multi_select'] == 'All') echo "selected";?>>All</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Cotton') echo "selected";?>>Cotton</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Polycotton') echo "selected";?>>Polycotton</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Modal') echo "selected";?>>Modal</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Polyester Cotton') echo "selected";?>>Polyester Cotton</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Polyester') echo "selected";?>>Polyester</option>
			<option  <?php if($res['camisoles_detail_fabric_multi_select'] == 'Viscos') echo "selected";?>>Viscos</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="camisoles_detail_style">
			<option value="">Select</option>
			<option <?php if($res['camisoles_detail_style'] == 'Basic') echo "selected";?>>Basic</option>
			<option  <?php if($res['camisoles_detail_style'] == 'Printed') echo "selected";?>>Printed</option>
		</select>
	</div>
</div>
<div class="form-group">
