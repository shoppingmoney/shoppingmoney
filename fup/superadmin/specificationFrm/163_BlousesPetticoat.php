...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="occasion_specification_occasion">
			...
			<option <?php if($res['occasion_specification_occasion'] == 'Casual') echo "selected";?>>Cotton</option>
			<option <?php if($res['occasion_specification_occasion'] == 'Formal') echo "selected";?>>Cotton Lycra</option>
			<option  <?php if($res['occasion_specification_occasion'] == 'Party') echo "selected";?>>Modal</option>
			<option  <?php if($res['occasion_specification_occasion'] == 'Semi-formal') echo "selected";?>>Nylon/Spandex</option>
			<option  <?php if($res['occasion_specification_occasion'] == 'Wedding') echo "selected";?>>Rayon</option>
		</select>
	</div>
</div>
<div class="form-group">
