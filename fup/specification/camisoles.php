                                                   ...
                                                   <tbody>
												    <tr>
													   ...
													   <tr>
                                                         ...
                                                         <td><?=$specification['key_feature_series'];?></td>
                                                      </tr>
													   <tr>
                                                ...
                                                <table class="table table-striped table-bordered">
                                                   <tbody>
												    <tr>
                                                         ...
                                                         <td><?=$specification['ideal_specification_ideal_for'];?></td>
                                                      </tr>
                                                        </tbody>
														</table>
											</div>
                                                ...
                                                <table class="table table-striped table-bordered">
                                                   <tbody>
												    <tr>
                                                         ...
                                                         <td><?=$specification['wash_care_detail_wash_care'];?></td>
                                                      </tr>
                                                        </tbody>
														</table>
												</div>	
												<div class="toch-table">
											     <h5>TOP SPECIFICATIONS </h5>
                                                <table class="table table-striped table-bordered">
                                                   <tbody>
												    <tr>
                                                         <td><strong>Fabric:</strong></td>
                                                         <td><?=$specification['camisoles_detail_fabric_multi_select'];?></td>
                                                      </tr>
													   <tr>
                                                         <td><strong>Style:</strong></td>
                                                         <td><?=$specification['camisoles_detail_style'];?></td>
                                                      </tr>
                                                        </tbody>
														</table>
												</div>
                                                ...
                                                <table class="table table-striped table-bordered">
                                                   <tbody>
												    <tr>
                                                         ...
                                                         <td><?=$specification['color_set_details_color_family_multi_select'];?></td>
                                                      </tr>
                                                        </tbody>
														</table>
												</div>															
