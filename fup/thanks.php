...
<!------end slide div------>
		...
		#thanksbox{margin: 0px auto;float:none;background:rgba(255, 255, 255, 0.5);box-shadow: 1px 1px 8px 0px #dedede;padding: 46px 25px;border-radius: 27px;border: 1px solid #d8d8d8;}
...
<div class="col-md-12" style="margin-top:3%;background-image:url(img/shopvector1.jpg);">
    <div class="col-md-6" id="thanksbox">
        <center><h1 style="color:#26acce;">Thanks for Placing Order</h1>
 <h5><b>Your order has been
Generated , please check<br>Your E-mail ID and Track your Order.</b></h5>
<h3>Your Order ID is: ORD0AB1</h3>
</center>		
    </div>
