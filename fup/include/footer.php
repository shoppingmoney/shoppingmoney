...
if($commonvip > 0){
?>
							<div class="modal-product" id="loginpp" style="overflow-y:scroll !important;">
...
<div class="col-md-12" style="margin-top:20px;padding:14px 0;overflow-y:scroll;height:135px;border:1px solid GAINSBORO;margin-right:5%;">
									 <div class"col-md-4">
...
<div class="col-md-4">
									...
									<li><a href="http://shoppingmoney.in/shop.php?product=32&catid=1&session=7240" style="color:#26acce;">Daily Needs</a></li>
									 <li><a href="http://shoppingmoney.in/shop.php?product=33&catid=1&session=4018">Motors & Accessories</a></li>

									 <li><a href="http://shoppingmoney.in/shop.php?product=39&catid=1&session=1603" >Sports, Fitness & Outdoors</a></li>
		 ...
		 <div class="modal fade" id="buybulk" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document" style="width:48% !important;">
                    <div class="modal-content" id="bxbg">
                        ...
                        <div class="col-md-12" style="    background: -webkit-linear-gradient(#EAEAEA,#fff,#E8E8E8);">
                            <div class="product-linee">
