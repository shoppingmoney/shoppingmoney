										...
										<div class="panel panel_default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a  href="#">Compare Air Conditioners</a>
												</h4>
											</div>
											<div id="checkout-options" class="collapse in">
												<div class="panel-body">
													<div class="row">
                                                        ...
                                                        <div class="ssb">
														<span class="compareprice2">left</span>
														</div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="col-sm-3" id="comparebox1">
															<span class="comparetxt"><a href="#">LG AC 1.5 ton 5star split AC</a></span>
															<span class="rating">
															...
															<span class="compareimgbox"><img src="img/trust.png" class="compareimg"></span>
															
															</div>
															
															<div class="col-sm-3" id="comparebox2">
															<span class="comparetxt"><a href="#">LG AC 1.5 ton 5star split AC</a></span>
															<span class="rating">
                                                            <i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i>                                 
                                                            </span>
															...
															<div class="col-sm-3" id="comparebox3">
															<span class="comparetxt"><a href="#">LG AC 1.5 ton 5star split AC</a></span>
															<span class="rating">
                                                            <i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i>                                 
                                                            </span>
															...
															<div class="col-sm-3" id="comparebox4">
															<span class="comparetxt"><a href="#">LG AC 1.5 ton 5star split AC</a></span>
															<span class="rating">
                                                            <i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i><i class="fa fa-star" style="color:gray;font-size:10px;"></i>                                 
                                                            </span>
                                                    ...
                                                    </div> <!-- End 1st row images -->
														
                                        <div class="col-sm-12" id="pricebb">
														
														 <div class="col-sm-2" id="pricehead">
                                                             
														
                                                        <div class="ssb">
														<span class="priceheadleft">Price</span>
														</div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="col-sm-3" id="comparebox1">
															<span class="compareprice2">Rs. 35490</span>
														  </div>
															
															<div class="col-sm-3" id="comparebox2">
															<span class="compareprice2">Rs. 21990</span>
															</div>
															
															<div class="col-sm-3" id="comparebox3">
															<span class="compareprice2">Rs. 29990</span>
															</div>
															
															<div class="col-sm-3" id="comparebox4">
															<span class="compareprice2">Rs. 41990</span>
														    </div>
                                                        ...
                                                        <div class="ssb2">
														<span class="priceheadleft">Warranty</span>
														</div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <div class="col-sm-3" id="comparebox1">
															<p>with 1 Year on Complete Unit and 4 Years on Compressor See Details</p>
														  </div>
