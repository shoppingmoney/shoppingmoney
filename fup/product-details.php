...
<?php $gethead=$dbAccess->selectSingleStmt("Select * from product_category where id IN(".$fetch['category_id']."0) and parent_id=0");
...
<?php } else{ } ?>
	...
	<div class="col span_1_of_5">
     ...
     <?php include("include/footer.php"); ?>
      <script>
	  function change_weight(pid){
		  //alert(pid);
		  window.location="<?=$_SERVER['PHP_SELF']?>?pid="+pid;
	  }
	  </script>
