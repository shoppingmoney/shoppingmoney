                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Vendor  <small>Sales Panel </small></h3>
                            </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <ul class="stats-overview">
											    <li>
													<a href="order_product.php?order=NEW">
													<?php
                                                ...
                                                <li>
													<a href="order_product.php?order=ALL">
