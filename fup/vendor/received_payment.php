                    ...
                    <div class="">
                        ...
                        <div class="row">            
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Recieved Payment<small>List</small></h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                               <?php 
													$ord=$dbAccess->selectData("SELECT * FROM transaction WHERE vendor_id = '".$vid['unique_user_id']."' AND status = 'Paid' ORDER BY id desc");
													$i=0;
													foreach ($ord as $or) {
														$i++;
