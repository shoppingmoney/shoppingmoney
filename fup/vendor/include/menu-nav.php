...
<li><a href="csvuploader.php">Upload Excel</a>
 ...
 <li><a href="product_list.php">List Of Products</a>
                  ...
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="sales.php"><i class="fa fa-reply" aria-hidden="true"></i> Return <span class="fa fa-chevron-right"></span></a></li>
    ...
    <li><a href="sponsored.php"><i class="fa fa-envelope-o" aria-hidden="true"></i> Support <span class="fa fa-chevron-right"></span></a></li>
