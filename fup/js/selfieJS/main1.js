;(function($, window, document, undefined) {
   ...
   arrowSlider();
    ...
    function clickMenu() {
	    if($(window).width()<768) {
	    	$(".wpc-menu:not(.classic) .main-menu > .menu-item-has-children > a, .wpc-menu .main-menu > .menu-item.menu-item-has-children .submenu .menu-item.menu-item-has-children > a").on("click", function(){           
