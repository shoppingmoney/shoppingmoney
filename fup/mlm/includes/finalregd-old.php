...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $get = finalregistration($column_r,$value_r,$bcolmn, $uid);//function to insert data for registration.
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12">
                                 ...
                                 <div class="col-sm-4 col-xs-12">
                                    <div class="single-create">
                                       ...
                                       <div class="row">
                                          <div class="col-xs-4">
                                             <select class="form-control" name="dob-date" id="date" required="">
                                                 <option>Date</option>
                                                 <?php
                                                 $range = range(1,31);
                                                 foreach($range as $r)
                                          ...
                                          <div class="col-sm-4 col-xs-12">
                                             <select class="form-control" name="dob-month" id="month" required="">
                                                 <option>Month</option>
                                                 <?php
                                                 $range = range(1,12);
                                                 foreach($range as $r)
                                          ...
                                          <div class="col-sm-4 col-xs-12">
                                             <select class="form-control" name="dob-year" id="year" required="">
                                                 <option>year</option>
                                                 <?php
                               ...
                               <div class="col-sm-4 col-xs-12">
                                    <div class="single-create">
                                       ...
                                       <div class="row">
                                          <div class="col-xs-4">
                                             <select class="form-control" name="nomnee-title" id="date" required="">
                                                <option>Mr</option>
                                                <option>Mrs</option>
                                                <option>Miss</option>
                                ...
                                <div class="col-sm-4 col-xs-12">
                                 ...
                                 <div class="col-sm-4 col-xs-12">
                                    ...
                                    <div class="single-create">
                                       ...
                                       <input class="form-control" type="text" name="pan-card" id="pancard" required="">
                                    </div>
                                 </div>
