...
?>
					...
					<div class="col-md-3" id="filterpart">
						...
						<div class="accordion_one">
							...
							<div id="divone2" class="collapse in">
								...
								<h3 class="title-group gfont-1">Mobile & Tablets</h3>
									<ul style="height:250px; overflow-y:scroll;">
										<li class="arrow-plus" id="sub-listing">
											<a href="#" id="#sub-link">
												<img src="superadmin/ico/mob.png" style="font-size: 16px;padding: 0px 1px;">Mobile Accessories &amp; 			
											</a>
										</li>
										<li class="arrow-plus" id="sub-listing">
											<a href="#">
										...
										<li class="arrow-plus" id="sub-listing">
											<a href="#">
												<img src="superadmin/ico/mob.png" style="font-size: 16px;padding: 0px 1px;">Mobile Phones &amp; 			
											</a>
										</li>
										<li class="arrow-plus" id="sub-listing">
											<a href="#">
												<img src="superadmin/ico/mob.png" style="font-size: 16px;padding: 0px 1px;">Televisions &amp; 			
											</a>
										</li>
										<li class="arrow-plus" id="sub-listing">
											<a href="#">
												<img src="superadmin/ico/mob.png" style="font-size: 16px;padding: 0px 1px;">All appliances &amp; 			
											</a>
										</li>
										<li class="arrow-plus" id="sub-listing">
											<a href="#">
												<img src="superadmin/ico/mob.png" style="font-size: 16px;padding: 0px 1px;">Laptop &amp; 			
											</a>
										</li>
      ...
      <div data-role="rangeslider">
        <label for="price-min">Price:Rs.</label>
        <input type="range" name="price-min" id="price-min" value="200" min="0" max="1000">
        <label for="price-max">Price:Rs.</label>
...
$getid = $_GET['product'];
						...
						?>
							...
							<h4><a class="accordion-trigger" data-toggle="collapse" href="#divone">Brand</a></h4>
                                                       <input type="search" name="search" class="brandsrch" placeholder="Search By Brand">
			  ...
			  <?php
			  foreach($qurey as $t){
 if (in_array("'".$t['brand']."'", $_GET['prodfilter'])){
$solve="checked";
}else{
$solve="";
}
if($t['brand']=='null' || $t['brand']==''){
			  ...
			  <?php
			  foreach($qurey as $t){
 if (in_array("'".$t['ptoduct_type']."'", $_GET['prodfilter'])){
$solve="checked";
}else{
$solve="";
}
						...
						<div class="product-area">
							...
							<div class="product-menu style-2">
								<ul role="tablist"><li><h4>Sort By :</h4> 
								    ...
								    <li role="presentation" class=""><a href="#display-1-2" role="tab" data-toggle="tab" aria-expanded="false">Price Low to High</a></li>
								    <li role="presentation" class=""><a href="#display-1-3" role="tab" data-toggle="tab" aria-expanded="false">Price High to Low</a></li>
									<li role="presentation" class=""><a href="#display-1-3" role="tab" data-toggle="tab" aria-expanded="false">Discount</a></li>
									<li role="presentation" class=""><a href="#display-1-3" role="tab" data-toggle="tab" aria-expanded="false">Fresh Arrivals </a></li><span>
								</ul>
...
if($nth['commission_type']=='percent'){
													$commission = ($nth['commission']*$nth['mrp'])/100;
												}else{
													$commission = $nth['commission'];
												}

												if($dsk['discount_type']=='rupees'){
												$atm = $nth['mrp']+$commission;




												$newatm = ($nth['mrp']+$commission) - $dsk['discount'];
												$ico = "Rs";
												}else if($dsk['discount_type']=='percent'){
												$atm = $nth['mrp']+$commission;
												$newatm = ($nth['mrp']+$commission) - (($nth['mrp']+$commission) * $dsk['discount'])/100 ;
												$ico = "%";
												}else{
												$atm = "";
												$newatm = $nth['mrp']+$commission;
												$ico = null;
												}
												...
												<div class="row">
													<div class="active-product-carosel">
														...
														$ngh = $img->selectData("select * from product_img where product_id = '".$t['product_id']."' ");
															...
															$dsk=$disc->selectSingleStmt("select * from discount where product_id = '".$t['product_id']."' ");
															if($dsk['discount']==0 || $dsk['discount']==null){
															$amt = null;
															}else{
															$amt = $dsk['discount'];
...
if($nth['commission_type']=='percent'){
												...
												if($dsk['discount_type']=='rupees'){
												$atm = $t['mrp']+$commission;
												$newatm = ($t['mrp']+$commission) - $dsk['discount'];
												$ico = "Rs";
												}else if($dsk['discount_type']=='percent'){
												$atm = $t['mrp']+$commission;
												$newatm = ($t['mrp']+$commission) - (($t['mrp']+$commission) * $dsk['discount'])/100 ;
												$ico = "%";
												}else{
												$atm = "";
												$newatm = $t['mrp']+$commission;
												$ico = null;
												}	
