...
<html class="no-js" lang="">
    ...
    <body style="background:#f7f7f7;">
        ...
        <div class="col-md-12" id="headercheck">
            ...
            <div class="col-md-5">
                <h5 class="headerrightline">People earn to shop.. You shop to earn</h5>
            </div>
        </div>
        <!-- HEADER AREA END -->
        <!-- START PAGE-CONTENT -->
                        ...
                        <div class="product-area">
                            <div class="row">
                                <div class="col-xs-10" >
                                    ...
                                    <div>
                                        <center><h3 style="color:red"><?php if(isset($_SESSION['paymentfailMesaage'])){ echo $_SESSION['paymentfailMesaage']; unset($_SESSION['paymentfailMesaage']); }?></h3></center>
                                    </div>
                                    ...
                                    <div class="panel panel_default" >
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <?php
                                                    if(isset($_SESSION['myemail']) && !empty($_SESSION['myemail'])){
                                                    	$cls ="";
                                                    }else{
                                                    	$cls = "collapsed";
                                                    }
                                                ...
                                                ?>
                                                <a class="accordion-trigger " data-toggle="collapse" data-parent="#accordion" href="#checkout-confirm" aria-expanded="true">1.Confirm Order<i class="fa fa-caret-down"></i> </a>
                                            </h4>
                                        </div>
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td class="text-right" id="subtotal">Rs.<?=number_format($price,2);?></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-right" colspan="4">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-right" id="total">Rs.<?=number_format($price,2);?></td>
                                                            </tr>
                                                            <?php
                                    ...
                                    <div class="panel panel_default" >
                                        ...
                                        <form method="post" action="payment.php" id="undertaking">
                                            ...
                                            <?php } 
                                                if($_GET['reevalue']=='no'){ ?>
                                            <input type="hidden" name="pays" value="<?=$price;?>" />
                                    ...
                                    <div class="panel panel_default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-trigger collapsed" data-toggle="collapse" data-parent="#accordion" href="#make-payment">3. Make Payment <i class="fa fa-caret-down"></i> </a>
                                            </h4>
                                        </div>
                                                ...
                                                <div class="tabordion">
                                                    ...
                                                    <section id="section2">
                                                        ...
                                                        <article>
                                                            ...
                                                            <div class="col-md-5"><input type="text" class="form-control" name="lastname" id="userid" placeholder="Amount" required="" style="width:250px;"> <br>
                                                                <input type="text" class="form-control" name="lastname" id="userid" placeholder="Date" required="" style="width:250px;">
                                                            </div>
                                                            <br>
                            ...
                            <div class="col-xs-2" id="cart_summary" Style="background-color:#FFFFFF; padding:5px;<?=$cart_div;?>">
                                ...
                                <h4 id="summary-ab">SUMMARY (0 Item)</h4>
                                <table style=" width:100%;">
                                    ...
                                    <?php
                                        $price = ($price+$vatamt+$tr['mrp'])+($shipping['shipping_charge']*$tr['qty']);
    ...
    <script type="text/javascript">
              ...
              $.ajax({
                    ...
                    data:{'action': 'itemCount'},
                      success: function(msg){
                        if(msg=="nologin"){msg=0;
                            window.location.href="checkout.php";}
                        $("#summary-ab").html("SUMMARY  ("+msg+" Item )");
                      },
                      error: function(){
     ...
     function rmove(id){
               ...
               for(var i=0; i <msg.length; i++){
                    // squan+=  pasrseInt(msg[i].quantity); 
                    tprice+= msg[i].price*msg[i].quantity;
               list += '<tr><td><div class="main-image images"><img alt="#" src="'+msg[i].image+'" width="50" height="40"><p style="float:right;">&nbsp;<span onclick="rmove('+msg[i].product_id+');"><img src="img/rem.png" height="10" width="15" title="Remove"></span></p><br><h4>'+msg[i].productname+'</h4></div></td><td><p>Rs. '+msg[i].price+'</p><p>shipping charges include(50)</p></td><td><p>0</p></td><td><div class="numbers-row"><form method="post"><input type="text" disabled="" name="qty" id="french-hens" value="'+msg[i].quantity+'" style="display: block;font-family: cursive;color: black;width: 50px;margin-top: 1px;"><input type="hidden" name="oid" value="147"><input type="hidden" name="oldprc" value="10"><input type="submit" id="son147" name="btnsave" value="save" style="display: none;font-family: cursive;color: black;border: none;width: 50px;margin-top: 1px;"></form></div></td><td><p style="font-size:12px;">You Pay: Rs. '+msg[i].price*msg[i].quantity+'</p></td></tr>';
               }
               $("#squan").html(squan);
               $("#subtotal,#total, #stotal").html("Rs. " + tprice);
                   }
