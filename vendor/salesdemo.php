                        ...
                        <div class="row">            
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
									...
									<ul class="tabbtn0">
                                       <li class="btn btn-primary">Packaging</li>
									    <li class="btn btn-success">Invoice</li>
										 <li class="btn btn-info">Manifest</li>
										  <li class="btn btn-warning">Shipping</li>
										   <li class="btn btn-danger">Delivery</li>
										   </ul>
                                        <div class="clearfix"></div>
