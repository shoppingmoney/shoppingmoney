                    ...
                    <div class="">
                        ...
                        <div class="row">            
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Ticket Id<small>List</small></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                               <?php 
													$ord=$dbAccess->selectData("SELECT * FROM request WHERE vid='".$vid['unique_user_id']."' order by id desc");
													$i=0;
													foreach ($ord as $or) {
														$i++;
                                                    ?>
                                                    <tr>
															...
															<td> <?php echo $helper->dateFormate($or['date']);?></td>
															<td><?php echo $or['status'];
															if($or['status']=='Closed') echo " on ".$helper->dateFormate($or['closed_date']);?></td>
															<td><?=$or['remark'];?></td>
                                                    </tr>
                                                   <?php
														}
