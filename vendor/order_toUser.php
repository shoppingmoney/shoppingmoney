                    ...
                    <div class="">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><?php 
                                        if(isset($_GET['ptype'])){
                                        if($_GET['ptype']==1) echo "Apporoved"; else if($_GET['ptype']==2) echo "Waiting For Approval"; 

                                        }else echo "";?><small></small></h2>
                                       <ul class="tabbtn0">
                        ...
                        <div class="row">            
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Orders List<small>(Billing to user)</small></h2>
                                            ...
                                            <tbody>
                                               <?php 
											        $sql = "SELECT chk.orderid,chk.date,chko.bill_status,usr.ufirstname,usr.ulastname,sum(chko.mrp) as mrp, count(chko.id) as item FROM checkout chk 
														   ...
														   WHERE chko.billing_type='Customer Name' AND chko.status > 2 AND chko.status <> 9 AND chko.vendor_id = '".$vid['unique_user_id']."' 
													...
													foreach ($ord as $or) {
														...
														if($or['bill_status']==0){
															...
															$url = "invoice.php?phone={$vid['phone']}&oid={$or['orderid']}&vid={$vid['unique_user_id']}";
														}else{
															$bstatus="Generated";
															$bmsg = "Get Invoice";
															$col = "success";
															$class = "";
															$url="getinvoice.php?phone={$vid['phone']}&oid={$or['orderid']}&vid={$vid['unique_user_id']}";
														} 
                                                    ?>
                                                    <tr>
                                                         <td><?= $i ?> </td>
