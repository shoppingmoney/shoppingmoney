...
function SmartWizard(target, options) {
    ...
    SmartWizard.prototype.goForward = function(){
		...
		if(nextStepIdx==2){
                ...
                //dstate,ddistrict,dcity,billaddress,billpincode
                var billpincode= $("#billpincode").val();
                var dcity= $("#dcity").val();
                ...
                var checkme = document.getElementById("diff").checked;
                ...
                //billstate_v,billdistrict_v,billcity_v,billaddress_v,billpincode_v
                //dstate,ddistrict,dcity,billaddress,billpincode
                if(checkme==false){
		if (billpincode == null || billpincode == '') {
                    $("#billpincode_v").fadeIn(1000);
                    status = 0;
                }
                if (dcity == null || dcity == '') {
                    $("#billcity_v").fadeIn(1000);
                    status = 0;
                }
				 if (ddistrict == null || ddistrict == '') {
                    $("#billdistrict_v").fadeIn(1000);
                    status = 0;
                }
                if (dstate == null || dstate == '') {
                    $("#billstate_v").fadeIn(1000);
                    status = 0;
                }
                if (billaddress == null || billaddress == '') {
                    $("#billaddress_v").fadeIn(1000);
                    status = 0;
                }               
				}
		...
		if(nextStepIdx==3){
			...
			if (docs == null || docs == '') {
             ...
             if (!panReg.test(comppan) || comppan == '') {
                    $("#comppan_v").fadeIn(1000);
                    status = 0;
             } 
			  if (compcst == null || compcst == '') {
                    $("#compcst_v").fadeIn(1000);
                    status = 0;
             }
              if (status == 0) {
                    return false;
