...
<div class="row">
            ...
            <a href="received_payment.php" class="count"> <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            ...
            <a href="pending_payment.php" class="count"><div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <p>Lorem ipsum psdea itgum rixt.</p>
                        ...
                        <div class="row">  
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><?php if(isset($_GET['ptype']) && ($_GET['ptype']=='1')){ echo "Apporoved";} else if(isset($_GET['ptype']) && ($_GET['ptype']=='2')){ echo "Waiting For Approval";}elseif(isset($_GET['ptype']) && ($_GET['ptype']=='3')){echo "Inactive";} else echo "All";?> Product List<small></small></h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
