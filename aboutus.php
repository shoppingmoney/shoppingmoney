...
$data=$dbAccess->selectSingleStmt("select * from cms where id='6'");
$data1=$dbAccess->selectSingleStmt("select * from cms where id='7'");
$data2=$dbAccess->selectSingleStmt("select * from cms where id='8'");
?>
        ...
        <section class="page-content">
            <div class="container">
                ...
                <div class="row">
                    <article>
                        <div class='parallax'>
                            <div class='foo_a' style="height:430px;">Aaa</div>
...
<div class="col-md-11 col-centered" style="margin-top:-3%; background: #fff">
		<div class="toch-review-title" id="about-container">
            <p class="about_heading head"> <?= $data['editor1'];?></p>
        </div>
...
<div class="col-md-12" style="margin-top:3%;background-image:url(img/shopvector1.jpg);">
    <div class="col-md-11" style="margin-left:9%;">
        ...
        <div class="col-md-1" style="height:597px;">
              <div class="prev-year" style="background:#da7777; color:#fff; border-radius:550px; width:44px; height:44px; font-size:15px;    padding: 11px 4px; margin-left: 11%;"  >2015</div>

<div class="line" style="border-left:1px dotted grey; width:2px; height: 491px;margin-left: 41%;"></div>

<div class="this-year" style="background:#26acce; color:#fff; border-radius:550px; width:44px; height:44px; font-size:15px;    padding: 11px 4px;     margin-top: 0px; margin-left: 11%;"  >2016</div>
        </div>
        <div class="col-md-5" style="margin-top: 30%;">	
            <div id="contain_slide">
                ...
                <div class="hideme">
                <div class="col-md-5">
                     <img src="img/face.png" style="margin-left:24px;box-shadow: 1px 1px 4px 0px; border-radius:100px; border-radius:100px;">
                </div>
                <div class="col-md-7"> 
                   <?= $data2['editor1'];?>
                </div>
