...
way and help your friend to choose a right product.
 ...
 <div class="col-md-6">
  ...
  <input type="radio" name="imgsize" value="Big_Image" checked><span class="sz">Image Size (410px x 214px)</span><br>
  <input type="radio" name="imgsize" value="Small_Image"><span class="sz">Image Size (214px x 214px)</span><br>
				</div>
