...
if($coc==1){
echo $msg1 = urlencode("We have received your order $ordId amounting to Rs.$grandmoney  and it is being processed, thanks for your order"); // otp sending code put here
}else{
echo $msg1 = urlencode("New order:- $ordId, notification amounting to:- Rs.$grandmoney, order by:- $firstname"); // otp sending code put here
}
$ID = 'argecom';
$Pwd = 'argecom';
