															...
															<div class="single-product" style="background:#fff;">
																...
																<div class="product-description">
																	...
																	<?php 
																		...
																		{ ?>
																			<span class="old-price">&nbsp<?php echo $atm?></span>
																	<?php	}
															...
															<div class="active-product-carosel">
																...
																<div class="recompro">
																	<div class="single-product">
																		...
																		<div class="product-description">
																			<center>
																				<h5><a href="product-details.php?pid=<?=$nth['product_id'];?>"><?php echo $nth['title'] ?></a></h5>
																				<div class="price-box">
																					<span class="price"><?php echo "Rs.".$newatm?></span>
																					<span class="old-price"><?php echo "Rs.".$atm?></span>
																				</div>
																...
																<div class="recompro">
																	<div class="single-product">
																		...
																		<div class="product-img">
																			...
																			if($imgs[0]=='' OR $imgs[1]=='')
																			    { ?>
																				  <img class="primary-img" src="images/images.png" >
																			      <img class="secondary-img" src="images/images.png">
																			   <?php }
																			else
																			    { ?>
																				  <img class="primary-img" src="<?=$imgs[0];?>" >
				...
				<center>
					<div class="container" style="background:#fff;margin-top:-26px;">
						<div class="row">
							<div class="bidcont">
								<div class="vidbox">
									<iframe width="457" height="270" src="https://www.youtube.com/embed/yEuQZi2kbCo" frameborder="0" allowfullscreen></iframe>
									<div class="vidtxt">
								...
								<div class="bidtxt"><a href="hot_deal.php"><img src="img/bid.jpg"></a></div>
								<div class="bidimg"><a href="hot_deal.php"><img src="img/bidimg.jpg"></a></div>
							</div>
