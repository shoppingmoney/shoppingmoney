...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="top_specifications_fabric_multi_select" value="<?=$res['top_specifications_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="top_specifications_style">
			<option value="">Select</option>
			<option <?php if($res['top_specifications_style'] == 'Backless') echo "selected";?>>Backless</option>
			<option  <?php if($res['top_specifications_style'] == 'Balloon') echo "selected";?>>Balloon</option>
			<option  <?php if($res['top_specifications_style'] == 'Basic') echo "selected";?>>Basic</option>
			<option  <?php if($res['top_specifications_style'] == 'Crop Tops') echo "selected";?>>Crop Tops</option>
			<option  <?php if($res['top_specifications_style'] == 'Elastic Waist') echo "selected";?>>Elastic Waist</option>
			<option  <?php if($res['top_specifications_style'] == 'Kaftan') echo "selected";?>>Kaftan</option>
			<option  <?php if($res['top_specifications_style'] == 'Racer Back') echo "selected";?>>Racer Back</option>
			<option  <?php if($res['top_specifications_style'] == 'Regular Shirts') echo "selected";?>>Regular Shirts</option>
			<option  <?php if($res['top_specifications_style'] == 'Paplum') echo "selected";?>>Paplum</option>
			<option  <?php if($res['top_specifications_style'] == 'Tube') echo "selected";?>>Tube</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="top_specifications_sleeve_length">
			<option value="">Select</option>
			<option <?php if($res['top_specifications_sleeve_length'] == 'Elbow Sleeve') echo "selected";?>>Elbow Sleeve</option>
			<option <?php if($res['top_specifications_sleeve_length'] == 'Long Sleeve') echo "selected";?>>Long Sleeve</option>
			<option  <?php if($res['top_specifications_sleeve_length'] == 'Half Sleeve') echo "selected";?>>Half Sleeve</option>
			<option  <?php if($res['top_specifications_sleeve_length'] == 'Sleeveless') echo "selected";?>>Sleeveless</option>
		</select>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="top_specifications_neckline" value="<?=$res['top_specifications_neckline']?>">
	</div>
</div>
<div class="form-group">
