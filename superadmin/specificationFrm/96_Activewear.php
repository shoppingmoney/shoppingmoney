...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="sportswear_detail_fabric">
			<option value="">Select</option>
			<option <?php if($res['sportswear_detail_fabric'] == 'Cotton Lycra') echo "selected";?>>Cotton Lycra</option>
			<option  <?php if($res['sportswear_detail_fabric'] == 'Nylon Polyester') echo "selected";?>>Nylon Polyester</option>
			<option  <?php if($res['sportswear_detail_fabric'] == 'Nylon Spandex') echo "selected";?>>Nylon Spandex</option>
			<option  <?php if($res['sportswear_detail_fabric'] == 'Polyamide Spandex') echo "selected";?>>Polyamide Spandex</option>
			<option  <?php if($res['sportswear_detail_fabric'] == 'Polyester') echo "selected";?>>Polyester</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="sportswear_detail_type">
			<option value="">Select</option>
			<option <?php if($res['sportswear_detail_type'] == 'Capris') echo "selected";?>>Capris</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Caps') echo "selected";?>>Caps</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Jackets') echo "selected";?>>Jackets</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Shorts') echo "selected";?>>Shorts</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Sports Bra') echo "selected";?>>Sports Bra</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Swimwear') echo "selected";?>>Swimwear</option>
			<option  <?php if($res['sportswear_detail_type'] == 'T-Shirts') echo "selected";?>>T-Shirts</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Tank Tops') echo "selected";?>>Tank Tops</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Tops') echo "selected";?>>Tops</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Track Suits') echo "selected";?>>Track Suits</option>
			<option  <?php if($res['sportswear_detail_type'] == 'Track Paints') echo "selected";?>>Track Paints</option>
		</select>
	</div>
</div>
<div class="form-group">
