...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="lehenga_details_fabric_multi_select" value="<?=$res['lehenga_details_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="lehenga_details_style_multi_select">
			<option value="">Select</option>
			<option <?php if($res['lehenga_details_style_multi_select'] == 'All') echo "selected";?>>All</option>
			<option  <?php if($res['lehenga_details_style_multi_select'] == 'A-line') echo "selected";?>>A-line</option>
			<option  <?php if($res['lehenga_details_style_multi_select'] == 'Fish Cut') echo "selected";?>>Fish Cut</option>
			<option  <?php if($res['lehenga_details_style_multi_select'] == 'Flared') echo "selected";?>>Flared</option>
		</select>
	</div>
</div>
<div class="form-group">
