...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="printed_legging_and_pallazzo_detail_fabric_multi_select" value="<?=$res['printed_legging_and_pallazzo_detail_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="color_set_details_color_family_multi_select">
			...
			<option  <?php if($res['color_set_details_color_family_multi_selectt'] == 'Brown') echo "selected";?>>Brown</option>
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="printed_legging_and_pallazzo_detail_type">
			<option value="">Select</option>
			<option <?php if($res['printed_legging_and_pallazzo_detail_type'] == 'Leggings') echo "selected";?>>Leggings</option>
			<option  <?php if($res['printed_legging_and_pallazzo_detail_type'] == 'Palazzo') echo "selected";?>>Palazzo</option>
		</select>
	</div>
</div>
<div class="form-group">
