...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Warranty Duration 
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="watch_specification_warranty_duration_multi_select">
			<option value="">Select</option>
			<option <?php if($res['watch_specification_warranty_duration_multi_select'] == 'All') echo "selected";?>>All</option>
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Warranty Type
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Dial Shape
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Dial Color
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Case Color
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="body_features_case_color_multi_select">
			<option value="">Select</option>
			<option <?php if($res['body_features_case_color_multi_select'] == 'All') echo "selected";?>>All</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Black') echo "selected";?>>Black</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Blue') echo "selected";?>>Blue</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Brown') echo "selected";?>>Brown</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Gold') echo "selected";?>>Gold</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Green') echo "selected";?>>Green</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Grey') echo "selected";?>>Grey</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Maroon') echo "selected";?>>Maroon</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Orange') echo "selected";?>>Orange</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Pink') echo "selected";?>>Pink</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Purpple') echo "selected";?>>Purpple</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Red') echo "selected";?>>Red</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Silver') echo "selected";?>>Silver</option>
			<option  <?php if($res['body_features_case_color_multi_select'] == 'Yellow') echo "selected";?>>Yellow</option>
		</select>
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Display
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="key_feature_model_id" value="<?=$res['key_feature_model_idssssssss']?>">
	</div>
</div>
<div class="form-group">
