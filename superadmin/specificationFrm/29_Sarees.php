...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Fabric $Muli-Select
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<input class="form-control col-md-7 col-xs-12" type="text" name="details_of_sarees_fabric_multi_select" value="<?=$res['details_of_sarees_fabric_multi_select']?>">
	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_sarees_type">
			<option value="">Select</option>
			<option <?php if($res['details_of_sarees_type'] == 'Embossed') echo "selected";?>>Embossed</option>
			<option  <?php if($res['details_of_sarees_type'] == 'Embroidered') echo "selected";?>>Embroidered</option>
			<option  <?php if($res['details_of_sarees_type'] == 'Hand Painted') echo "selected";?>>Hand Painted</option>
			<option  <?php if($res['details_of_sarees_type'] == 'Lace') echo "selected";?>>Lace</option>
			<option  <?php if($res['details_of_sarees_type'] == 'Printed') echo "selected";?>>Printed</option>
			<option  <?php if($res['details_of_sarees_type'] == 'Solid') echo "selected";?>>Solid</option>
		</select>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_sarees_style">
			<option value="">Select</option>
			<option <?php if($res['details_of_sarees_style'] == 'Lehenga Saree') echo "selected";?>>Lehenga Saree</option>
			<option  <?php if($res['details_of_sarees_style'] == 'Normal Saree') echo "selected";?>>Normal Saree</option>
		</select>
	</div>
</div>
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12">Blouse Piece
	</label>
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_sarees_blouse_piece">
			<option value="">Select</option>
			<option <?php if($res['details_of_sarees_blouse_piece'] == 'With Blouse') echo "selected";?>>With Blouse</option>
			<option  <?php if($res['details_of_sarees_blouse_piece'] == 'Without Blouse') echo "selected";?>>Without Blouse</option>
		</select>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<select class="form-control" name="details_of_sarees_saree_length">
			<option value="">Select</option>
			<option <?php if($res['details_of_sarees_saree_length'] == '5mts') echo "selected";?>>5mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.1mts') echo "selected";?>>5.1mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.2mts') echo "selected";?>>5.2mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.3mts') echo "selected";?>>5.3mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.4mts') echo "selected";?>>5.4mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.5mts') echo "selected";?>>5.5mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.6mts') echo "selected";?>>5.6mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.7mts') echo "selected";?>>5.7mts</option>
			<option  <?php if($res['details_of_sarees_saree_length'] == '5.8mts') echo "selected";?>>5.8mts</option>
		</select>
	</div>
</div>
<div class="form-group">
