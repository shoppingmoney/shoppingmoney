...
//echo "Working";
    $getuser = $dbAccess->selectSingleStmt("select * from  superadmin where email = '".$helper->escapeStr($_POST['login'])."' and password = '".$helper->escapeStr($_POST['pass1'])."' and status = '1' ");
    if ($getuser['email'] != null || $getuser['email'] != '') {
        $_SESSION['superEmail'] = $getuser['email'];
		$_SESSION['aName'] = $getuser['username'];
        header("location:index.php");
    } else {
        ...
        <section class="login_content">
          <form method="post">
            ...
            <div class="separator">
              ...
              <br />
              <div>
                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> ShoppingMoney</h1>
