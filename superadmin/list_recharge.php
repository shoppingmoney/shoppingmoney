...
$getData = $dbAccess->selectData("select * from  redeem WHERE action=1 order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
													...
													//$user = $dbAccess->selectSingleStmt("SELECT ");
														...
														<td><?= $r; ?></td>
                                                            <td><?php echo $name;?></td>
															 ...
															 <td><?= $t['branch'];?></td>
															 <td><?= $t['trans_id'];?></td>
															 <td><a  href="../mlm/docs/<?= $t['doc'];?>" download ><img src="../mlm/docs/<?= $t['doc'];?>" height="70" width="90" /></a></td>
															  <td><?php echo $date;?></td>
