...
if(isset($_GET['status'])){
	@extract($_GET);
	$dbAccess->updateData("UPDATE product_rate SET statusi='$status' WHERE id=$id");
	die();
}



$loopdata = $dbAccess->selectData("select * from product_rate where user_id = '".$_GET['userID']."' ");
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
$lr=$dbAccess->selectSingleStmt("select * from product_tbl where product_id = '".$t['product_id']."'");
?>
                                                            <td><?= $lr['title']; ?></td>
<td><?= $t['name']; ?></td>
                                                            <td><?= $t['email']; ?></td>
...
<script>
        ...
        xmlhttp.open("GET", "myreviewpro.php?id=" + id + "&status="+st, true);
        xmlhttp.send();
					  }
				  }
				  </script>
