...
if(isset($_GET['delid'])){
	@extract($_GET);
	$dbAccess->updateData("delete from product_category WHERE id=$delid");
	header("location:category.php");
	die();
}
$getData = $dbAccess->selectData("select * from  product_category ");
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <tbody>
					 <?php
                                                    ...
                                                    foreach ($getData as $t) {
                                                        ...
                                                        <tr>
														<td><?= $r; ?></td>
                                                            <td><?php echo $dbAccess->categoryOption($t['parent_id'],$t['category_name']);?></td>
...
<!--<button type="button" onClick="deleteme('<?=$t['id']?>');" class="btn btn-danger btn-xs">Delete</button>-->
                                                             <a href="update_category.php?cid=<?= $t['id']; ?>&requestAct=<?= rand(1000, 100000); ?>"><button type="button" class="btn btn-warning btn-xs">Edit</button></a>
															 </td>
														</tr>
                                                        <?php
                                                        $r++;
