...
$("#ve1").fadeOut(200);
                                ...
                                <form  method="post" onsubmit="return regvendor()">
                                    ...
                                    <dl>
                                        ...
                                        <input  style="width:79%;height: 27px;" class="input_select" type="text" placeholder="Name" name="name" id="inputName" autocomplete="off" onkeypress="return (event.charCode > 64 && event.charCode <91)||(event.charCode > 96 && event.charCode <123) || event.charCode==32"  value="">
...
<span id="vs1" style="display:none;">This Fields Is Required</span>
                                    ...
                                    <dl>       
                                        <input class="input_select" autocomplete="off" type="text" placeholder="Phone" name="phone" id="inputPhoness" maxlength="10" onkeypress="return (event.charCode > 47 && event.charCode <58)||event.charCode == 08|| event.charCode==09">
