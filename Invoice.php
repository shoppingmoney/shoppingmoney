...
<div id=":1ap" class="a3s" style="overflow: hidden;"><u></u>         
...
<table style="max-width:59%" cellpadding="0" cellspacing="0" width="100%"> <tbody>
<tr> 
...
<table style="max-width:59%;border-left:solid 1px #e6e6e6;border-right:solid 1px #e6e6e6;padding-top: 16px;" cellpadding="0" cellspacing="0" width="100%"> <tbody>
<tr>
<td style="line-height: 21px;"> 
<ul >
<li style="list-style-type:none;font-size: 11px;"><b>Order ID:</b> Of000000000000000000</li>
<li style="list-style-type:none;font-size: 11px;"><b>Order Date:</b> 19-05-2016</li>
<li style="list-style-type:none;font-size: 11px;"><b>Invoice Date:</b> 19-05-2016</li>
<li style="list-style-type:none;font-size: 11px;"><b>VAT/TIN:</b> 00000000000</li>
<li style="list-style-type:none;font-size: 11px;"><b>CST #:</b> 00000000000</li>
</ul>
</td>
...
<li style="list-style-type:none;font-size: 11px;">Saurav Mahtha<br>

C/o Buoyant technosolutions,D-38,<br>

Lower Ground Floor.. Hauz Khas,<br>

Near Hauz Khas Main Market., Near<br>

Hauz Khas Police Station.<br>

New Delhi 110016 Delhi<br>
...
<li style="list-style-type:none;font-size: 11px;"><b>Saurav Mahtha</b><br>
...
<table style="max-width:59%;border-left:solid 1px #e6e6e6;border-right:solid 1px #e6e6e6" cellpadding="0" cellspacing="0" width="100%"> <tbody> 
<tr> 
...
<table width="59%" border="1" style="border-collapse: collapse;font-size:11px;">
...
<td><?=$ye['unit_prc'];?></td>
<td><?=$ye['shipping'];?></td>
<td><?php echo $ye['shipping']+$ye['mrp']; ?></td>
</tr>
<?php } ?>
...
<td></td>
<?php
$totaamy = $dbAccess->selectSingleStmt("select sum(mrp+shipping) as coil from cart where user_id = '".$_SESSION['myemail']."' ");
?>
<td><?=$totaamy['coil'];?></td>
</tr>
...
<div style="clear:both; height:250px;border-left: 1px solid #e6e6e6;border-right: 1px solid #e6e6e6;width:59%;position:relative;"></div>



<table style="max-width:59.12%;border-left:solid 1px #e6e6e6;border-right:solid 1px #e6e6e6;border-bottom:1px solid #e6e6e6;" cellpadding="0" cellspacing="0" width="100%"> <tbody>
<th>
